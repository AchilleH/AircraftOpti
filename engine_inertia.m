function [Ixe, Iye, Ize, Ixze] = engine_inertia(engineweight,nacelleradius,XZtoengineCG,XYtoengineCG,YZtoengineCG,enginelength)
...
XP = YZtoengineCG; % distance from yz plane (nose tip) to engine CG
l_e = enginelength;
